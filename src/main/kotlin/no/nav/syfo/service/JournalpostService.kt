...
class JournalpostService(
    ...
    suspend fun ferdigstillJournalpost(accessToken: String, ferdigstillRegistrering: FerdigstillRegistrering, loggingMeta: LoggingMeta) {
        if (!safJournalpostService.erJournalfoert(journalpostId = ferdigstillRegistrering.journalpostId, token = accessToken)) {
            ...
            log.info("Hopper over oppdaterOgFerdigstillJournalpost, journalpostId ${ferdigstillRegistrering.journalpostId} er allerede journalført")
        }
    }
}
